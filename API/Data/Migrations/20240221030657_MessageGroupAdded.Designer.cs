...
namespace API.Data.Migrations
{
    ...
    [Migration("20240221030657_MessageGroupAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Extensions.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Extensions.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("API.Extensions.MessageGroup", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Extensions.AppUserRole", b =>
                {
                    b.HasOne("API.Extensions.AppRole", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("API.Extensions.Connection", b =>
                {
                    b.HasOne("API.Extensions.MessageGroup", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("API.Extensions.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
